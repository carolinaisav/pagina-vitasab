    ...
    <header className="sticky top-0 z-50 border-b border-accent/15 bg-sand/90 backdrop-blur">
      ...
      <div className="mx-auto flex w-full max-w-6xl items-center gap-6 px-6 py-5 sm:px-8 sm:py-6">
        ...
        <nav
          ...
          className="hidden flex-1 items-center justify-between gap-x-5 min-[1100px]:flex"
        >
          {NAV.map((item) => {
        ...
        <CTA href={wa} variant="primary" className="hidden shrink-0 min-[1100px]:inline-flex">
          Agendar hora
        </CTA>

        <details ref={menuRef} className="relative ml-auto min-[1100px]:hidden">
          <summary
            aria-label="Menú"
